  ...
  >
    ...
    <button onClick={closeModal}>Close</button>
      ...
      <div className="overflow-y-auto shadow-lg rounded-lg h-[95vh] min-w-[20vw] bg-gray-100" >
        ...
        <h3 className="text-lg text-center mb-4">Please fill out the form below to register for the Defence Day.<br /> Registration for future webinars will be released soon.</h3>
        <Formik
